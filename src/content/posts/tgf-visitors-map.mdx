...
tags: ['dataviz', 'maps', 'parkrun', 'data', 'visualization', 'community']
---

import { tgfVisitorsMapConfig } from '../../data/tgf-visitors-map-config.js';
import VisitorMap from '../../components/for_posts/VisitorMap/VisitorMap.astro'; // No change needed
...
<VisitorMap mapAlign="mapFull" mapConfig={tgfVisitorsMapConfig} />
