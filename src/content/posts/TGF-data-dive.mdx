...
pubDate: 2022-03-19
category: Play
featureImage: /src/assets/uploaded_images/tgf_busesRIGHT.jpg
...
![14 buses plus one for the doggies](../../assets/uploaded_images/tgf_busesRIGHT.jpg)
...
<ApexChart
  id="tgf-attendance"
  chartConfig={{ ...attendanceOptions, series: attendanceSeries }}
...
<ApexChart
  id="tgf-generations"
  chartConfig={{ ...generationsOptions, series: generationsSeries }}
  chartAlign="imageRight"
/>
...
<ApexChart
  id="tgf-finish-times"
  chartConfig={{ ...finishTimesOptions, series: finishTimesSeries }}
  chartAlign="chartFull"
/>
...
<ApexChart
  id="tgf-time-distribution"
  chartConfig={{ ...timeDistOptions, series: timeDistSeries }}
  chartAlign="imageRight"
/>
...
_Icon credits: London Bus by ATOM, Dog by Loka Mariella both found at_ [_NounProject.com_](https://nounprojects.com)
