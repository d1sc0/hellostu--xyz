...
import ApexChart from '../../components/for_posts/ApexChart.astro';
import {
  attendanceOptions,
  attendanceSeries,
  finishTimesOptions,
...
<ApexChart
  ...
  series={generationsSeries}
  chartClass="imageRight"
/>
...
<ApexChart
  id="tgf-finish-times"
  type="line"
  options={finishTimesOptions}
  series={finishTimesSeries}
  chartClass="chartFull"
/>
...
<ApexChart
  ...
  type="bar"
  options={timeDistOptions}
  series={timeDistSeries}
  chartClass="imageRight"
/>
