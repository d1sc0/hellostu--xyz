...
import ChoroplethMap from '../../components/for_posts/ChoroplethMap.astro';
import { fireMapConfig } from '../../data/fire-map-config.js';
...
<ChoroplethMap id="map" mapAlign="imageLeft" mapConfig={fireMapConfig} />
